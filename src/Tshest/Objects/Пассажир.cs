...
namespace IIS.Tshest
{
    ...
    public class Пассажир : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tshest.КодБрони fКодБрони;
        
        private IIS.Tshest.МестоНаРейс fМестоНаРейс;
        ...
        [PropertyStorage(new string[] {
                "КодБрони"})]
        [NotNull()]
        public virtual IIS.Tshest.КодБрони КодБрони
        {
            get
            {
                ...
                IIS.Tshest.КодБрони result = this.fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "МестоНаРейс"})]
        [NotNull()]
        public virtual IIS.Tshest.МестоНаРейс МестоНаРейс
        {
            get
            {
                ...
                IIS.Tshest.МестоНаРейс result = this.fМестоНаРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПассажирE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирE", typeof(IIS.Tshest.Пассажир));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПассажирL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирL", typeof(IIS.Tshest.Пассажир));
                }
            }
        }
    }
