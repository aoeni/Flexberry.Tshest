...
namespace IIS.Tshest
{
    ...
    public class Рейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tshest.DetailArrayOfИнфБронь fИнфБронь;
        ...
        public virtual IIS.Tshest.DetailArrayOfИнфБронь ИнфБронь
        {
            get
            {
                ...
                {
                    this.fИнфБронь = new IIS.Tshest.DetailArrayOfИнфБронь(this);
                }
                IIS.Tshest.DetailArrayOfИнфБронь result = this.fИнфБронь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсE", typeof(IIS.Tshest.Рейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсL", typeof(IIS.Tshest.Рейс));
                }
            }
        }
    }
